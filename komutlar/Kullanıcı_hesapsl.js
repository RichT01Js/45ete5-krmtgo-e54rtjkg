...
exports.run = async (client, message, args) => {
  ...
  const embed = new Discord.MessageEmbed()
    .setColor('RED')
    .setTitle('UYARI <:slotrushmember:1188809299451977808>')
    .setFooter(client.ekoayarlar.embedmesajyapimci)
    .setDescription(`
${message.author}
> Hesabını silmek üzeresin emin misin?
> **"Evet<:accepts:1188812293048369233>"** Veya **"Hayır<:deny:1188812328070819900>"** Yazın!
  ...
  message.channel.awaitMessages(filter, { max: 1, time: 90000, errors: ['time'] })
    .then(async (collected) => {
      ...
      if (response === 'evet') {
        ...
        message.channel.send(`${user}, Hesabınız başarıyla silindi. <:accepts:1188812293048369233>`);
        ...
        message.channel.send(`${user}, İşlem iptal edildi. <:deny:1188812328070819900>`);
      }
    })
    .catch(() => {
      message.channel.send(`${user}, Hesap silme işlemi zaman aşımına uğradı. <:deny:1188812328070819900>`);
    });
};
