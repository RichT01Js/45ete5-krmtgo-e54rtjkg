...
exports.run = async (client, message, args) => {
  ...
  message.channel.send(`${silinecekkllnc} adlı yetkili ${message.author} adlı kullanıcının bakiyesine **+${formattedPara} ${client.ekoayarlar.parabirimi}** miktarında para yatırdı`);
}
