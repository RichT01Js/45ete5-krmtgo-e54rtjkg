...
if (message.channel.type === 'dm') {
  ...
  message.channel.send(`${silinecekkllnc} adlı yetkili ${message.author} adlı kullanıcının bakiyesinden **-${formattedPara} ${client.ekoayarlar.parabirimi}** miktarında para aldı`); 
}
